...
describe('User - add some more to cart', function () {
    ...
    it("tickets should be present", function () {
        ...
        expect(json.items[0].quantity).to.equal(4);
    ...
    it("fees should be present", function () {
        ...
        expect(json.items[1].quantity).to.equal(4);
    ...
    it("total should be correct", function () {
        expect(json.total_in_cents).to.equal(12140);
    })

    it("should report 46 remaining tickets available", function () {
        expect(json.limited_tickets_remaining[0].tickets_remaining).to.equal(46);
    });
